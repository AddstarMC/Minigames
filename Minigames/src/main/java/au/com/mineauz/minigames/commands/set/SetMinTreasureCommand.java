...
public class SetMinTreasureCommand implements ICommand {
    ...
    public @NotNull Component getDescription() {
        return MinigameMessageManager.getMgMessage(MinigameLangKey.COMMAND_SET_MINTREASURE_DESCRIPTION);
    }
    @Override
    public Component getUsage() {
        return MinigameMessageManager.getMgMessage(MinigameLangKey.COMMAND_SET_MINTREASURE_USAGE);
    }
        ...
        if (args != null) {
            ...
            if (thm != null) {
                if (args[0].matches("[0-9]+")) {
                    ...
                    MinigameMessageManager.sendMgMessage(sender, MinigameMessageType.INFO, MinigameLangKey.COMMAND_SET_MINTREASURE_SUCCESS,
