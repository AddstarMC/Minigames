...
public class TreasureHuntModule extends MinigameModule{
	...
	public boolean displayMechanicSettings(Menu previous){
		...
		itemsTreasureHunt.add(location.getMenuItem("Location Name", Material.RED_BED, MinigameUtils.stringToList("Name to appear when;treasure spawns")));
		...
		treasureHunt.addItem(new MenuItemPage("Back", Material.REDSTONE_TORCH, previous), treasureHunt.getSize() - 9);
