...
public class SetMaxRadiusCommand implements ICommand { //todo it isn't intuitive, that this belongs to treasure hunt
    ...
    public @NotNull Component getDescription() {
        return MinigameMessageManager.getMgMessage(MinigameLangKey.COMMAND_SET_MAXRADIUS_DESCRIPTION);
    }
    @Override
    public Component getUsage() {
        return MinigameMessageManager.getMgMessage(MinigameLangKey.COMMAND_SET_MAXRADIUS_USAGE);
    }
        ...
        if (args != null) {
            ...
            if (thm != null) {
                if (args[0].matches("[0-9]+")) {
                    ...
                    MinigameMessageManager.sendMgMessage(sender, MinigameMessageType.INFO, MinigameLangKey.COMMAND_SET_MAXRADIUS_SUCCESS,
