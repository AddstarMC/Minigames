...
public class SetItemPickupCommand extends ASetCommand {
    ...
    public @NotNull Component getDescription() {
        return MinigameMessageManager.getMgMessage(MgCommandLangKey.COMMAND_SET_ITEMSPICKUP_DESCRIPTION);
    }

    @Override
    public Component getUsage() {
        return MinigameMessageManager.getMgMessage(MgCommandLangKey.COMMAND_SET_ITEMSPICKUP_USAGE);
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Minigame minigame,
        ...
        if (args != null) {
            ...
            if (bool != null) {
                ...
                MinigameMessageManager.sendMgMessage(sender, MinigameMessageType.INFO, MgCommandLangKey.COMMAND_SET_ITEMSPICKUP_SUCCESS,
