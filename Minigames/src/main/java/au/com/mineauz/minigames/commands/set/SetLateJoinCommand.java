...
public class SetLateJoinCommand extends ASetCommand {
    ...
    public @NotNull Component getDescription() {
        return MinigameMessageManager.getMgMessage(MgCommandLangKey.COMMAND_SET_LATEJOIN_DESCRIPTION);
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Minigame minigame,
        ...
        if (args != null) {
            ...
            if (bool != null) {
                ...
                MinigameMessageManager.sendMgMessage(sender, MinigameMessageType.INFO, MgCommandLangKey.COMMAND_SET_LATEJOIN_SUCCESS,
