...
public class MenuItem {
    ...
    public MenuItem(@NotNull String name, @Nullable Material displayMat) {
        this(name, null, displayMat);
    }

    public MenuItem(@NotNull String name, @Nullable List<@NotNull String> description, @Nullable Material displayMat) {
        if (displayMat == null)
            if (description == null) {
    ...
    public @Nullable List<@NotNull String> getDescriptionStr() {
        return displayItem.getItemMeta().getLore();
    }

    public @Nullable List<@NotNull Component> getDescriptionComp() {
        return displayItem.getItemMeta().lore();
    }

    @Deprecated(forRemoval = true)
    public void setDescriptionStr(@Nullable List<@NotNull String> description) {
        ItemMeta meta = displayItem.getItemMeta();
    ...
    public void setDescriptionComp(@Nullable List<@NotNull Component> description) {
        ItemMeta meta = displayItem.getItemMeta();
