...
public class DegenAreaMode implements ToolMode {
	...
	public void onLeftClick(MinigamePlayer player, Minigame minigame,
		...
		if(player.hasSelection()){
			...
			player.sendMessage("Created a degeneration area for " + minigame, MessageType.Normal);
		}
			...
			player.sendMessage("Cleared degeneration area from " + minigame, MessageType.Normal);
		}
	}
	...
	public void select(MinigamePlayer player, Minigame minigame, Team team) {
		if(minigame.getFloorDegen1() != null && minigame.getFloorDegen2() != null){
			...
			player.sendMessage("Selected degeneration area in " + minigame, MessageType.Normal);
		}
		else{
			player.sendMessage("No degeneration area selected for " + minigame, MessageType.Error);
		}
	}
